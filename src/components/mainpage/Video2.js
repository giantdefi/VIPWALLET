        ...
        <>
            ...
            <div className="videoId fadeIn animated mx-auto border-4">
                <div className="playId "
                    ...
                    onClick={() => handleVideoNumber(2)} hidden={parseInt(bgNumber) === 2 ? true : false} />

                <ReactPlayer
                    url="https://www.youtube.com/watch?v=68r-Z6LwKrM&ab_channel=Biteable"
                    playing={playNumber === 2 ? true : false}
                    // onStart={handleStart}
                    onEnded={handleEnd}
                    controls
                    width='100%'
