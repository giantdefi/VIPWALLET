        ...
        <>
            ...
            <div className="videoId fadeIn animated mx-auto border-4">
                <div className="playId "
                    ...
                    onClick={() => handleVideoNumber(1)} hidden={parseInt(bgNumber) === 1 ? true : false} />

                <ReactPlayer
                    url="https://www.youtube.com/watch?v=ycaZ4vpYB4g&ab_channel=KatstenGrafica"

                    playing={playNumber === 1 ? true : false}
                    // onStart={handleStart}
                    onEnded={handleEnd}
                    controls
                    width='100%'
