...
export default function Users() {
  ...
  //  const { domain, title, desc, masterUser } = useSelector((state) => state.GeneralReducer)
   ...
   // const [isLogin, setLoginr] = useState(false)
    const { isLogin, fullname, isActive } = useSelector((state) => state.AuthReducer)
                    ...
                    <button onClick={() => handleMovePage('users/matching-bonus')} className="btn_menu_user w-1/3 h-[90px]">
                        <div className=" flex flex-col justify-center items-center">
                            {menuSpinner && itemLink == "users/matching-bonus" ?
                                ...
                                : <>
                                    <i className="icofont-flora-flower text-yellow-300 text-4xl "></i>
                                    <p className="text-[11px] mt-1">ROI</p>
                                </>
                            }
                        </div>
                    </button>
                            ...
                            {menuSpinner && itemLink == "users/confirmation" ?
                                ...
                                : <>
                                  ...
                                  <i className="icofont-flora-flower text-4xl  text-yellow-400"></i> 
                                    <p className="text-xs mt-2">aaaaa</p>
                                </>
                            }
                        </div>
                    </button>
                    ...
                    <button onClick={() => handleMovePage('users/send-e-wallet')} className="btn_menu_user w-1/3 h-[90px]">
                     ...
                     <div className=" flex flex-col justify-center items-center">
                         {menuSpinner ?
                             ...
                             : <>
                                 <i className="icofont-loop text-4xl  text-yellow-200"></i>
