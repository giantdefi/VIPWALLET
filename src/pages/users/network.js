  ...
  //  const { width, height } = useWindowSize() //coffety
    ...
    useEffect(() => {
       ...
       // if(allowReload) {
            handleGetNetwork()
       // }
      //  dispatch(setAllowReload(false)) // move to axios return
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [allowReload, level, boardNo]) // get userdata first then load network
            ...
            <div className="flex justify-end ">
                ...
                {myNetwork.slot_2?
                    ...
                    <button  className=" w-1/2 h-[60px]">
                        ...
                        {activateSpinner && myNetwork.empty_slot == 11 ?
