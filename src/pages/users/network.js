                        ...
                        <div className=" flex flex-col justify-center items-center">
                            {menuSpinner && itemLink == "users/matching-bonus" ?
                                ...
                                : <>
                                    ...
                                    <p className="text-[11px] mt-1">VIP1000000001</p>
                                </>
                            }
                        </div>
                    </button>
...
<button onClick={() => handleMovePage('users/matching-bonus')} className="btn_menu_user rounded-lg">
    <div className=" flex flex-col justify-center items-center">
        {menuSpinner && itemLink == "users/matching-bonus" ?
            ...
            : <>
                <i className="icofont-rocket-alt-1 text-yellow-300 text-4xl "></i>
                <p className="text-[11px] mt-1">VIP1000000002</p>
            </>
        }
    </div>
</button>
                    ...
                    <button onClick={() => handleMovePage('users/confirmation')} className="btn_menu_user">
                        <div className=" flex flex-col justify-center items-center">
                            {menuSpinner && itemLink == "users/confirmation" ?
                                ...
                                : <>
                                    <i className="icofont-rocket-alt-1 text-4xl  text-yellow-400"></i>
                                    <p className="text-xs mt-2">VIP1000000003</p>
                                </>
                            }
                        </div>
                    </button>
                    ...
                    <button onClick={() => handleMovePage('users/send-e-wallet')} className="btn_menu_user">
                        <div className=" flex flex-col justify-center items-center">
                            {menuSpinner && itemLink == "users/send-e-wallet" ?
                                ...
                                : <>
                                    <i className="icofont-rocket-alt-1 text-yellow-400 text-4xl"></i>
                                    <p className="text-xs mt-2">VIP1000000004</p>
                                </>
                            }
                        </div>
                    </button>
                    ...
                    <button onClick={() => handleMovePage('users/send-e-wallet')} className="btn_menu_user">
                        <div className=" flex flex-col justify-center items-center">
                            {menuSpinner && itemLink == "users/send-e-wallet" ?
                                ...
                                : <>
                                    <i className="icofont-rocket-alt-1 text-yellow-400 text-4xl"></i>
                                    <p className="text-xs mt-2">VIP1000000005</p>
                                </>
                            }
                        </div>
                    </button>
                ...
                <div className="text-center py-2 mt-2 bg-gray-700">
                    <p className="uppercase ">READY TO THE NEXT LEVEL</p>
                </div>
