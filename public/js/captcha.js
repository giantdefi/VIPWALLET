(function () {
    ...
    var extend = function () {
        ...
        for (var i = 1; i < length; i++) {
            ...
            for (var key in source) {
                // Using for in will traverse all enumerable properties of the array, including prototypes. 
    ...
    _proto.initDOM = function () {
        ...
        var sliderIcon = createElement('i', 'icofont-arrow-right sliderIcon');
    ...
    _proto.initImg = function () {
        ...
        var L = this.options.sliderL + this.options.sliderR * 2 + 3; // Actual side length of slider
        ...
        img.setSrc = function () {
            ...
            if (!src || src === '') src = '/js/captcha2.png';
            if (isIE) { // IE browser cannot cross domain through img.crossOrigin, use ajax to get image blob and then convert it to dataURL to display 
